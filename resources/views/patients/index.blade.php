        ...
        <div class="input-group" id="adv-search">
            ...
            <div class="input-group-btn">
                <div class="btn-group" role="group">
                    ...
                    <button ng-click="submit()" type="button" class="btn btn-primary"><loading></loading><span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>
                </div>
            </div>
        </div>
        <div >
         ...
         <a  ng-show="!list.length" ng-repeat="x in list track by x.id" ng-click = "selectedPx(x.id)" class="col-sm-offset-2 col-sm-8" id="@{{x.id}}">@{{ x.surname + ', ' + x.first_name }}</a>
                            ...
                            <form action="{{ url('patient') }}" method="POST" class="form-horizontal"  name = "userForm" novalidate>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-3 col-sm-6">
                                        <button ng-click="save_patient()" type="button" class="btn btn-primary" ng-disabled="userForm.$invalid"><loading></loading><i class="fa fa-btn fa-sign-in"></i> Save Patient
                                        </button>
                                    </div>
                                </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        <button ng-click="patient_histories()" type="button" class="btn btn-primary" ng-disabled="userForm.$invalid">
                                            <loading></loading><i class="fa fa-btn fa-sign-in"></i> @{{button.text}}
                                        </button>
                                    </div>
                                </div>
                                {{--  <div >
